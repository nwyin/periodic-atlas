...
def test_hm_inv5_element_index_deterministic():
    ...
    try:
        ...
        empty: dict[str, list] = {}
        result1 = build_viewer._build_element_index(elements_list, empty, empty, empty, empty)
        result2 = build_viewer._build_element_index(elements_list, empty, empty, empty, empty)
    finally:
        con.close()
